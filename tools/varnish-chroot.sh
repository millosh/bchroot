...
# usr/lib
cd $CHROOT/usr/lib
cp -f /usr/lib/libopcodes-2.20.1-system.20100303.so .
cp -f /usr/lib/libbfd-2.20.1-system.20100303.so . 
cp -f /usr/lib/crti.o .
